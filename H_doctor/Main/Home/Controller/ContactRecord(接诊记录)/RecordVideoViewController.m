...
@interface RecordVideoViewController ()<DZNEmptyDataSetSource, DZNEmptyDataSetDelegate,UITableViewDelegate,UITableViewDataSource>
...
#define Identifier @"RecordVideoTableViewCell"
...
-(void)getChatRecord
{
    GetSignSickerAllInquiryService *request = [[GetSignSickerAllInquiryService alloc] initWithDocid:self.userId type:@"1"];
    
    [request startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
        //        NSLog(@"视频问诊记录 %@",request.responseString);
